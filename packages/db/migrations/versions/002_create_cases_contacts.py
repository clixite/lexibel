...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.String(50), nullable=False, server_default=sa.text("'open'")
        ),
        ...
        sa.Column(
            "opened_at", sa.Date, nullable=False, server_default=sa.text("CURRENT_DATE")
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "language", sa.String(5), nullable=False, server_default=sa.text("'fr'")
        ),
        sa.Column(
            "created_at", sa.DateTime, nullable=False, server_default=sa.text("now()")
        ),
