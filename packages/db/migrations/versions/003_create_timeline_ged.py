...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("id", UUID(as_uuid=True), server_default=sa.text("gen_random_uuid()"), primary_key=True),
        sa.Column("tenant_id", UUID(as_uuid=True), sa.ForeignKey("tenants.id", ondelete="RESTRICT"), nullable=False, index=True),
        sa.Column("interaction_event_id", UUID(as_uuid=True), sa.ForeignKey("interaction_events.id", ondelete="RESTRICT"), nullable=False, index=True),
    ...
    op.create_table(
        ...
        sa.Column("suggested_case_id", UUID(as_uuid=True), sa.ForeignKey("cases.id", ondelete="SET NULL"), nullable=True),
