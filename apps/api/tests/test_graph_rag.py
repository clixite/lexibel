...
class TestGraphRAGService:
    ...
    def test_context_for_query_with_case(self):
        ...
        context = self.rag.get_context_for_query(
            "Art. 1382", TENANT_ID, case_id="case-1"
        )
        assert context.entity_count >= 1
    ...
    def test_graph_search(self):
        self._build_case(
            ...
            [
                {
                    "id": "d1",
                    "text": "Le Tribunal de première instance de Bruxelles a jugé",
                },
            ],
        )
    ...
    def test_find_similar_cases_shared_entities(self):
        ...
        self._build_case(
            ...
            [
                {
                    "id": "d1",
                    "text": "Art. 1382 C.C. appliqué à Bruxelles pour accident",
                },
            ],
        )
        self._build_case(
            ...
            [
                {
                    "id": "d2",
                    "text": "Art. 1382 C.C. invoqué à Bruxelles pour responsabilité",
                },
            ],
        )
    ...
    def test_find_similar_cases_different_entities(self):
        self._build_case(
            ...
            [
                {
                    "id": "d1",
                    "text": "Maître Dupont à Bruxelles invoque Art. 1382 C.C.",
                },
            ],
        )
        self._build_case(
            ...
            [
                {
                    "id": "d2",
                    "text": "La société Acme SA à Gand devant le Tribunal de première instance de Gand",
                },
            ],
        )
    ...
    def test_context_text_summary(self):
        self._build_case(
            ...
            [
                {
                    "id": "d1",
                    "text": "Maître Dupont et Me Martin plaident devant le Tribunal de première instance de Bruxelles",
                },
            ],
        )
        context = self.rag.get_context_for_query(
            "Bruxelles", TENANT_ID, case_id="case-1"
        )
    ...
    def test_context_paths(self):
        self._build_case(
            ...
            [
                {
                    "id": "d1",
                    "text": "Maître Dupont à Bruxelles devant le Tribunal de première instance de Bruxelles",
                },
            ],
        )
        context = self.rag.get_context_for_query(
    ...
    def test_combined_vector_graph_context(self):
        ...
        self._build_case(
            ...
            [
                {
                    "id": "d1",
                    "text": "Maître Dupont invoque Art. 1382 C.C. pour un accident à Bruxelles",
                },
            ],
        )
    ...
    def test_multiple_cases_shared_court(self):
        ...
        self._build_case(
            ...
            [
                {
                    "id": "d1",
                    "text": "Devant le Tribunal de première instance de Bruxelles, Art. 1382 C.C.",
                },
            ],
        )
        self._build_case(
            ...
            [
                {
                    "id": "d2",
                    "text": "Le Tribunal de première instance de Bruxelles a statué, Art. 1382 C.C.",
                },
            ],
        )
