...
api_requests_total = Counter(
    "lexibel_api_requests_total", "Total API requests", ["method", "endpoint", "status"]
)
...
brain_actions_total = Counter(
    "lexibel_brain_actions_total", "Total BRAIN actions", ["action_type", "status"]
)

brain_insights_total = Counter(
    "lexibel_brain_insights_total", "Total BRAIN insights", ["insight_type", "severity"]
)
...
prophet_prediction_duration_seconds = Histogram(
    "lexibel_prophet_prediction_duration_seconds", "PROPHET prediction duration"
)
...
sentinel_check_duration_seconds = Histogram(
    "lexibel_sentinel_check_duration_seconds", "SENTINEL conflict check duration"
)
...
timeline_extraction_duration_seconds = Histogram(
    "lexibel_timeline_extraction_duration_seconds", "Timeline extraction duration"
)

# Database metrics
db_connections_active = Gauge(
    "lexibel_db_connections_active", "Active database connections", ["database"]
)
