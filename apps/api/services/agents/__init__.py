...
from apps.api.services.agents.due_diligence_agent import (
    DueDiligenceAgent,
    DueDiligenceReport,
)
...
class AgentOrchestrator:
    ...
    def assemble_document(
        ...
        return self.document_assembler.assemble(
            template_name, case_data, variables or {}
        )
